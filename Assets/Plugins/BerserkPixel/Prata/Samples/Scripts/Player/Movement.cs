...
namespace Project.Scripts.Player
{
    public class Movement : MonoBehaviour
    {
        ...
        //sometimes I like to make a ReadOnly attribute to display private variables like this,
        //allowing for info to be layered out nicer in the inspector
        ...
        private void Start()
        {
            /*
             ...
             - I would recommend creating a separate Player Class and using that to hold all player info such as 
               the rigidbody and make separate movement, combat, classes for specific functions
             - Highly recommend looking into abstacrtion, decoupling and inheritance if you're working on a large project
            */
